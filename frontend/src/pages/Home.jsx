            ...
            <div className='flex flex-col lg:flex-row gap-[90px] items-center justify-between'>
                ...
                <div>
                    <div className='lg:w-[570px]'>
                         ...
                         md:leading-[70px]'>
                            We help Save the Pets
                            </h1>
                            <p className='text_para'>  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                 Ullam aliquam reprehenderit voluptatem
                                  esse ex sed vel. Vel eos 
                                  cumque minima.
                ...
                <div className='xl:w-[670px]'>
                    ...
                    <ul className='pl-4'>
                        <li className='text_para'>
                            ...
                            <li className='text_para'>
                            2.Schedule Appointment Directly
                            </li> 
                            <li className='text_para'>
                            3.Schedule Appointment Directly Lorem ipsum dolor
